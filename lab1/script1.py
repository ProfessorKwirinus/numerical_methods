...
with open("tabulation.test.txt", "w") as f:
...
plt.annotate('БС Заросляк\n(Старт)', xy=(distances[0], elevations[0]),
             xytext=(distances[0] + 800, elevations[0] - 150),
             arrowprops=arrow_style, fontsize=10, fontweight='bold', color='black')

plt.annotate('г. Говерла\n(Фініш)', xy=(distances[-1], elevations[-1]),
             xytext=(distances[-1] - 800, elevations[-1] - 150),
             arrowprops=arrow_style, fontsize=10, fontweight='bold', color='black')
